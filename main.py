...
data = [
    ...
    ["одиннадцатого", "двенадцатого", "тринадцатого", "четырнадцатого", "пятнадцатого", "шестнадцатого", "семнадцатого",
     "восемьнадцатого", "девятнадцатого"],
...
if __name__ == '__main__':
    assert convert("30.02.0010 15:21:50") == 'тридцатое февраля десятого года пятнадцать часов ' \
                                             'двадцать одна минута пятьдесят секунд'
    assert convert("17.01.9999 11:10:36") == 'семнадцатое января девять тысяч девятьсот девяносто ' \
                                             'девятого года одиннадцать часов десять минут тридцать шесть секунд'
    assert convert("03.02.1000 00:00:00") == 'третье февраля тысячного года ноль часов ноль' \
                                             ' минут ноль секунд'
    assert convert("31.02.0015 09:11:40") == 'тридцать первое февраля пятнадцатого года девять' \
                                             ' часов одиннадцать минута сорок секунд'
